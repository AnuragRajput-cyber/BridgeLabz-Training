package dsa_practice.Runtime_Analysis_and_BigO_Notation;
    ...
    public static void main(String args[]){
        ...
        for(int size:datasetSizes){
            ...
            if(size<=10000){
                ...
                bubbleTime=(endBubble-startBubble)/1000000.0;
            }
            long startMerge=System.nanoTime();
            MergeSort.mergeSort(dataset2,0,dataset2.length-1);
            long endMerge=System.nanoTime();
            double mergeTime=(endMerge-startMerge)/1000000.0;
            long startQuick=System.nanoTime();
            QuickSort.quickSort(dataset3,0,dataset3.length-1);
            long endQuick=System.nanoTime();
            double quickTime=(endQuick-startQuick)/1000000.0;
